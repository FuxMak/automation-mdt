REM ############################################################################################################
REM Script		    :		MDT Imaging - AdjustDefaultUserProfileWin11
REM Author		    :		Marco Fuchs (https://github.com/FuxMak)
REM Description  	:		Deploys a collection of Windows 11 registry keys to the HKCU hive of the default user:
...
REM reg add "HKLM\DEFAULT\Software\Microsoft\Command Processor" /v "DefaultColor" /t REG_DWORD /d "02" /f
...
reg delete "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\Explorer" /v "EnableAutoTray" /f


REM Hide Bluetooth Tray icon
REM ECHO "Hiding Bluetooth Tray icon..."
REM reg add "HKLM\DEFAULT\Control Panel\Bluetooth" /v "Notification Area Icon" /t REG_DWORD /d 0 /f
...
reg add "HKLM\DEFAULT\Software\Microsoft\GameBar" /v "UseNexusForGameBarEnabled" /t REG_DWORD /d 0 /f
...
REM General - Show me suggested content in the Settings app
reg add "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-353696Enabled" /t REG_DWORD /d 1 /f
...
reg add "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\SearchSettings" /v "IsDeviceSearchHistoryEnabled" /t REG_DWORD /d 0 /f
...
reg add "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "Start_TrackDocs" /t REG_DWORD /d 0 /f


REM -------------------------------------------------------------------------------------------------------------
REM -------------------------------------------- Start menu ------------------------------------------

reg add "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\Explorer\StartPage" /v "MakeAllAppsDefault" /t REG_DWORD /d 1 /f
